...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0, score1):
        ...
        if diff > biggest_change:
            biggest_change = diff
            print(biggest_change, "point(s)! That's the biggest gain yet for Player", who)

        if who == 0: return announce_highest(who, biggest_change, score0)
        return announce_highest(who, biggest_change, score1) 
    return say
    # END PROBLEM 7
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    # BEGIN PROBLEM 11
    tens, ones = opponent_score // 10, opponent_score % 10
    bacon_points = max(2 * tens - ones, 1)
    if is_swap(score + bacon_points, opponent_score):
        if score + bacon_points < opponent_score:
            return 0
        elif score + bacon_points > opponent_score:
            return num_rolls
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    return 4  # Replace his statement
    # END PROBLEM 12
